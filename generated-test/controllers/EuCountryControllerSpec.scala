...
class EuCountryControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val euCountryRoute = routes.EuCountryController.onPageLoad(NormalMode).url
  ...
  "EuCountry Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(EuCountryPage, true).success.value
